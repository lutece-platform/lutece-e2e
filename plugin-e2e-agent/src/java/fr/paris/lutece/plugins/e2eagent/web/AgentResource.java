...
public class AgentResource {
    ...
    public Response testConnection(UrlRequest request, @Context HttpHeaders headers,
        ...
        try {
            ...
            LOGGER.warn("Connexion refusee", e);
    ...
    private TestResponse testLuteceAuth(String baseUrl, String username, String password) {
        ...
        try {
            ...
            LOGGER.info("DoAdminLogin response: status={}, location={}", authStatus, location);
            ...
            if ((authStatus == 302 || authStatus == 303) && location != null) {
                ...
                try (BufferedReader reader = new BufferedReader(
                    ...
                    LOGGER.warn("Erreur lecture reponse: {}", e.getMessage());
                }
                conn.disconnect();
                ...
                LOGGER.info("Final page: url={}, status={}, isAdminMenu={}, isErrorPage={}, isLoginPage={}",
                    finalUrl, finalStatus, isAdminMenu, isErrorPage, isLoginPage);
            ...
            LOGGER.warn("Erreur test authentification", e);
