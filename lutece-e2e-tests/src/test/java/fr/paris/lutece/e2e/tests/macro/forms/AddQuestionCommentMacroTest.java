...
/**
 * Brique macro : ajouter une question de type {@code COMMENT} (commentaire).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question commentaire")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionCommentMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.COMMENT;
    private static final String TITLE = "Question commentaire";

    @Step("Ajouter une question commentaire")
    ...
    @Test
    @DisplayName("Ajouter une question commentaire (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
