...
/**
 * Brique macro : ajouter une question de type {@code TERMS_OF_SERVICE} (conditions d'utilisation).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question conditions d'utilisation")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionTermsOfServiceMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.TERMS_OF_SERVICE;
    private static final String TITLE = "Question conditions d'utilisation";

    @Step("Ajouter une question conditions d'utilisation")
    ...
    @Test
    @DisplayName("Ajouter une question conditions d'utilisation (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
