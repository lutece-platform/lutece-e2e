...
/**
 * Brique macro : ajouter une question de type {@code CAMERA} (camera).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question camera")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionCameraMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.CAMERA;
    private static final String TITLE = "Question camera";

    @Step("Ajouter une question camera")
    ...
    @Test
    @DisplayName("Ajouter une question camera (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
