...
/**
 * Brique macro : ajouter une question de type {@code IMAGE} (telechargement d'image).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question telechargement d'image")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionImageMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.IMAGE;
    private static final String TITLE = "Question telechargement d'image";

    @Step("Ajouter une question telechargement d'image")
    ...
    @Test
    @DisplayName("Ajouter une question telechargement d'image (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
