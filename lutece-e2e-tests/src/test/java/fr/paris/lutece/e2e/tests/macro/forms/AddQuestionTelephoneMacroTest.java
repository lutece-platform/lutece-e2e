...
/**
 * Brique macro : ajouter une question de type {@code TELEPHONE} (numero de telephone).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question numero de telephone")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionTelephoneMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.TELEPHONE;
    private static final String TITLE = "Question numero de telephone";

    @Step("Ajouter une question numero de telephone")
    ...
    @Test
    @DisplayName("Ajouter une question numero de telephone (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
