...
/**
 * Brique macro : ajouter une question de type {@code MYLUTECE_ATTRIBUTE} (attribut MyLutece).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question attribut MyLutece")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionMyluteceAttributeMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.MYLUTECE_ATTRIBUTE;
    private static final String TITLE = "Question attribut MyLutece";

    @Step("Ajouter une question attribut MyLutece")
    ...
    @Test
    @DisplayName("Ajouter une question attribut MyLutece (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
