...
/**
 * Brique macro : ajouter une question de type {@code NUMBERING} (numerotation).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question numerotation")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionNumberingMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.NUMBERING;
    private static final String TITLE = "Question numerotation";

    @Step("Ajouter une question numerotation")
    ...
    @Test
    @DisplayName("Ajouter une question numerotation (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
