...
/**
 * Brique macro : ajouter une question de type {@code GEOLOCATION} (geolocalisation).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question geolocalisation")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionGeolocationMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.GEOLOCATION;
    private static final String TITLE = "Question geolocalisation";

    @Step("Ajouter une question geolocalisation")
    ...
    @Test
    @DisplayName("Ajouter une question geolocalisation (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
