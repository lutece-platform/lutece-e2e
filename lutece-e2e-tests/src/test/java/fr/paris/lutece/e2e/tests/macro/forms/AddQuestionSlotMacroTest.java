...
/**
 * Brique macro : ajouter une question de type {@code SLOT} (creneau horaire).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question creneau horaire")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionSlotMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.SLOT;
    ...
    @Test
    @DisplayName("Ajouter une question creneau horaire (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
