...
/**
 * Brique macro : ajouter une question de type {@code SESSION} (session).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question session")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionSessionMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.SESSION;
    private static final String TITLE = "Question session";

    @Step("Ajouter une question session")
    ...
    @Test
    @DisplayName("Ajouter une question session (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
