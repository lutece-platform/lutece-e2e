...
/**
 * Brique macro : ajouter une question de type {@code FILE} (fichier).
 *
...
@Epic("Forms")
@Feature("Questions")
@Story("Ajouter une question fichier")
@Tag("macro")
@Tag("forms")
@Tag("brick")
public class AddQuestionFileMacroTest extends MacroTest {

    private static final QuestionType TYPE = QuestionType.FILE;
    private static final String TITLE = "Question fichier";

    @Step("Ajouter une question fichier")
    ...
    @Test
    @DisplayName("Ajouter une question fichier (auto-provisionnement ; ignoree si type non pilotable)")
    void standalone() {
